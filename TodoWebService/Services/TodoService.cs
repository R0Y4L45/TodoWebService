...
namespace TodoWebService.Services
{
    public class TodoService : ITodoService
    {
        ...
        public async Task ChangeTodoNotify(int id, bool notify)
        {
            var item = await _context.TodoItems.FirstOrDefaultAsync(e => e.Id == id);
        ...
        public async Task<List<TodoItem>> GetTodoAllItems() => await _context.TodoItems.ToListAsync();
    }
}
